...
$('body').on('click', '.password-checkbox-check', function(){
	if ($(this).is(':checked')){
		$('#chesk_password').attr('type', 'text');
	} else {
		$('#chesk_password').attr('type', 'password');
	}
});